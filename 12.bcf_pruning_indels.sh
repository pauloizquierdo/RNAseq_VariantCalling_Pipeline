...
bcftools view -v indels population.vcf.gz -Ob -o population_indels.bcf

bcftools view -i 'QUAL>40 && INFO/DP>20 && F_MISSING<0.1' population_indels.bcf -Ov -o population_indels_Q40_DP20_FM01.vcf
