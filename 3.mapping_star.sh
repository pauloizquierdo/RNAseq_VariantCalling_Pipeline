...
STAR --genomeDir ${GENOME_DIR} \
     ...
     --runThreadN 10 \
     --outFileNamePrefix ${MAPPING}/${SAMPLE_NAME}_ \
     --readFilesCommand zcat \
     --outSAMtype BAM SortedByCoordinate \
     --limitBAMsortRAM 20000000000

# Samples 22 and 74 have issues

# Save job info
scontrol show job $SLURM_JOB_ID > ${MAPPING}/${SAMPLE_NAME}_job_info_bwa_align_${SLURM_ARRAY_TASK_ID}.txt